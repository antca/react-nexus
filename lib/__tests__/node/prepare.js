...
describe('prepare', () => {
  ...
  describe('preparedApp', () => {
    it('is rendered as the original app', async () => {
      function Foo() {
        return <span>Foo</span>;
      }
      const app = <Foo />;
      const preparedApp = await prepare(app);
      const appHtml = ReactDOMServer.renderToString(app);
      const preparedAppHtml = ReactDOMServer.renderToString(preparedApp);
      should(preparedAppHtml).be.exactly(appHtml);
    });
    it('is rendered as the original app with nested elements', async () => {
      function Bar() {
    ...
    it('is rendered as the original app with null children', async () => {
      function Bar() {
        return null;
      }
      function Foo() {
    ...
    it('is rendered as the original app with false children', async () => {
        function Bar() {
            return false;
        }
        function Foo() {
    ...
    it('is rendered as the original app with special elements', async () => {
      function Foo() {
        return (
          <div>
            Foo
